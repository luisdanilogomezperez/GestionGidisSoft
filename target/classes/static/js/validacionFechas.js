...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var anioFinSele = document.getElementById("anioFinSeleccionado").getAttribute("data-anioFin");
    var anioInicioSele = document.getElementById("anioInicioSeleccionado").getAttribute("data-anioInicio");
